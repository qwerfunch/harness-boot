...
- Gate 5 자동 실행 (runtime smoke) — v0.3.7+
- F-006 확장: Code / Doc / Anchor drift (현재 5/8) — v0.3.7+
- `/harness:metrics` (F-008) — v0.3.7+
- 템플릿 보강: NEW-51/52/53
...
[Unreleased]: https://github.com/qwerfunch/harness-boot/compare/v0.3.6...HEAD
