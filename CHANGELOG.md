...
- F-012 Claude sub-agents · F-014 Hooks 시스템 — `agents/` · `hooks/` 디렉터리 인프라 신규 필요 → v0.4 minor bump 와 함께
- F-002 Modes A/R/B-2 실 interactive 흐름 — LLM 대화 루프 실구현 → v0.4 후보
- Phase 3 CI — `.github/workflows/self-check.yml` + PR gate (v0.4+)
- 템플릿 보강: NEW-51/52/53
...
[Unreleased]: https://github.com/qwerfunch/harness-boot/compare/v0.3.13...HEAD
