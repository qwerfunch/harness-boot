...
- Phase 2 Active dogfood — 실제 피처부터 `scripts/work.py` / `/harness:work` 로 state + events 기록 (v0.3.11+)
...
[Unreleased]: https://github.com/qwerfunch/harness-boot/compare/v0.3.10...HEAD
