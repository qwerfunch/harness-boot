...
- 템플릿 보강: NEW-51/52/53
- gate_runner auto-detect 개선: `tests/unit/` 가 package 일 때 `python3 -m unittest discover tests.unit` 사용 (v0.3.12 후보)
...
[Unreleased]: https://github.com/qwerfunch/harness-boot/compare/v0.3.11...HEAD
