...
[![plugin](https://img.shields.io/badge/plugin-v0.15.5-blue)](.claude-plugin/plugin.json)
[![tests](https://img.shields.io/badge/tests-846%20passing-brightgreen)](tests/parity)
