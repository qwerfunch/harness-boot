...
function canonicalize(value) {
    ...
    if (typeof value === 'number') {
        if (!Number.isFinite(value)) {
            throw new TypeError(`canonical_hash: non-finite number encountered (${String(value)}); ` +
    ...
    if (typeof value === 'object') {
        ...
        if (proto !== Object.prototype && proto !== null) {
            throw new TypeError('canonical_hash: only plain objects are canonicalizable; ' +
    ...
    throw new TypeError(`canonical_hash: cannot serialize value of type ${typeof value}.`);
}
/**
 ...
 */
export function subtreeHashes(spec) {
    const result = {};
 ...
 */
export function merkleRoot(subtrees) {
...
//# sourceMappingURL=canonicalHash.js.map