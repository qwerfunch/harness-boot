 ...
 */
import { activate as workActivate, complete as workComplete, runAndRecordGate as workRunGate, } from '../work.js';
/**
 ...
 */
export function mapSuggestion(suggestion) {
    ...
    switch (action) {
        ...
        case 'add_evidence':
            return {
                kind: 'halt',
                reason: 'manual',
                message: 'declared evidence required (BR-015 — drive does not self-issue evidence). ' +
        ...
        case 'init_feature':
            return {
                kind: 'halt',
                reason: 'manual',
                message: 'spec.yaml change required — return to Phase A (drive --plan-only) ' +
 ...
 */
export function executeAction(harnessDir, action, hooks = {}) {
