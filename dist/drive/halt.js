 ...
 */
export const HALT_REASON_INDEX = {
 ...
 */
export function emitHalt(harnessDir, reason, message, context = {}) {
    ...
    appendProgress(harnessDir, `${ts} HALT #${index.n} ${index.tag}${featureSegment}${gateSegment}: ${message}`);
    // 3. events.log
    const event = {
        ts,
        type: 'drive_halted',
 ...
 */
export function renderHaltMessage(emission) {
