...
const EN = {
    ...
    progress_line_split: '  progress: {passed}/{total} gates passed · {evidence} evidence ({human} human, {llm} llm)',
...
const KO = {
    ...
    progress_line_split: '  진행: 검증 {passed}/{total} 통과 · 근거 {evidence} 개 (사람 {human}, 기계 {llm})',
