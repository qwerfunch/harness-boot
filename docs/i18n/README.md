...
A pre-F-041 Korean snapshot is preserved at
[`docs/archive/i18n-ko-frozen-f041/`](../archive/i18n-ko-frozen-f041/) (F-042
moved it under `docs/archive/` to make its frozen status visually obvious). It
is **not synced** with the masters — treat it as out-of-date the moment any
English file changes; use it as a translation reference, not as documentation.
