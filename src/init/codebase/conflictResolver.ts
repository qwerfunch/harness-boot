...
export const CONVENTION_DOC_CANDIDATES: ReadonlyArray<string> = [
  'CLAUDE.md',
  '.cursorrules',
  'AGENTS.md',
];
...
export function detectConventionDocs(projectRoot: string): ReadonlyArray<string> {
 ...
 * conventions.md.
 */
export function resolveConventionConflict(
  projectRoot: string,
...
function appendConventionsBlock(targetPath: string, conventionsBody: string): void {
  const guarded =
