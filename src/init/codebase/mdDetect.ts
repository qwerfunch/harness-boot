 ...
 */
export const NON_PLAN_MARKDOWN: ReadonlyArray<string> = [
  'readme.md',
  'changelog.md',
  'license.md',
  'contributing.md',
 ...
 */
export function detectPlanDocCandidate(root: string): string | null {
  ...
  const candidates = entries.filter((entry) => {
    ...
    if (NON_PLAN_MARKDOWN.includes(entry.toLowerCase())) return false;
    return true;
  });
 ...
 */
export function detectPlanDocCandidatePath(root: string): string | null {
