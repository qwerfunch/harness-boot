 ...
 */
function ironLawRequireHumanEvidence(harnessDir: string): boolean {
 ...
 */
function countDeclaredEvidenceByAuthor(
  feature: Feature,
 ...
 */
function autowireDraftPromotion(harnessDir: string): void {
  ...
  try {
    ...
    process.stderr.write(
      `[warn] draft auto-promotion failed: ${(err as Error).message}\n`,
    );
  }
}
